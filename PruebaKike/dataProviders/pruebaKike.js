...
(function() {
    var provider = app.data.pruebaKike = new Everlive({
            offlineStorage: true,
            appId: '6sebob9r9d61bfw5',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'pruebaKike_access_token',
...
// START_CUSTOM_CODE_pruebaKike
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_pruebaKike