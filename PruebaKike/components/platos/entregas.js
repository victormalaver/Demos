    ...
    cargaPosAlmacenesDespachador: function () {
        ...
        map.on('click', function (e) {
            if (miUbicacion) {
                ...
                console.log("SI existe ubicación entrega");
            }else{
                console.log("NO existe ubicación entrega");
            }
...
(function (parent) {
    var dataProvider = app.data.pruebaKike,
        fetchFilteredData = function (paramFilter, searchFilter) {
            var model = parent.get('entregasModel'),
        ...
        entregasModel = kendo.observable({
            ...
            searchChange: function (e) {
                ...
                fetchFilteredData(entregasModel.get('paramFilter'), searchFilter);
            }
        });

    parent.set('entregasModel', kendo.observable({
        onShow: function (e) {
            // Reset the form data.
        },
        onSaveClick: function (e) {
            var dataSource = entregasModel.get('dataSource');
            console.log(111111);
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('entregasModel', entregasModel);
        });
    } else {
        parent.set('entregasModel', entregasModel);
    }
